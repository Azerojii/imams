  ...
  return (
    <div className="infobox w-full">
                  ...
                  return (
                    <tr className="border-t border-border-light">
                      ...
                      <td className="py-1.5 px-3">
                        ...
                        <span className="mr-1 inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800">
                          حالي
                        </span>
                      </td>
                    </tr>
      ...
      {mosquesServed && mosquesServed.length > 0 && (
        <>
          <div className="infobox-section-header">المساجد التي عمل فيها</div>
          <table className="w-full border-collapse text-sm">
            <tbody>
